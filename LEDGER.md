...
it. If it finds no transcripts, pass `--session-cwd <dir>` with the
directory the session was launched from. Energy estimate for the
whole ledger: `ledger.py --energy-total`.
